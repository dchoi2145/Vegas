...
pros::Task angle(inertialValue, (void*)"PROS", TASK_PRIORITY_DEFAULT, TASK_STACK_DEPTH_DEFAULT, "");
void initialize() {
  ...
  ez::as::auton_selector.add_autons({
    Auton("WP\n\nDrive forward and come back.", WP),
    Auton("Elims Left\n\nTurn 3 times.", elimsLeft),
    Auton("Elims Right\n\nDrive forward, turn, come back. ", elimsRight),
    Auton("SKill\n\nSlow down during drive.", skills),
